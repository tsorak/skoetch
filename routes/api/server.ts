...
import * as room from "../../communication/roomHandler.ts";
import { removeSocket, storeSocket } from "../../communication/socketHandler.ts";
import * as _defaultCanvas from "../../communication/defaultCanvas.ts"
...
export const handler = (req: Request, _ctx: HandlerContext): Response => {
    if (req.headers.get("upgrade") != "websocket") {
        return new Response("Websocket only", { status: 501 });
    }
